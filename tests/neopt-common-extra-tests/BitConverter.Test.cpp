...
TEST_CASE("neopt extra tests - Test ToBase64String I")
{
   ...
   string convertedBase64 = neopt::ToBase64String(byteArray);

   REQUIRE(convertedBase64 == "AAECAwQFBgcICQoLDA0ODxAREhMUFRYXGBkaGxwdHh8gISIjJCUmJygpKissLS4vMDEyMzQ1Njc4
